...
$postId = (int) ($argv[1] ?? 0);
if ($postId <= 0) {
    fwrite(STDERR, "Usage: php bin/test-linkedin-compose.php <post_id>\n");
    exit(1);
}
...
$payload = [
    ...
    'accountKind' => (string) ($account['account_kind'] ?? 'root'),
...
echo "Dry-run LinkedIn compose for post {$postId}\n";
